...
export default function AdminOrders() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto font-sans bg-white min-h-screen text-neutral-800">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-neutral-100 mb-6">
        <div>
          ...
          <p className="text-xs text-neutral-400 font-medium mt-1">
            Pantau status pembayaran Midtrans dan manifest pengiriman logistik.
          </p>
        </div>
      </div>

      {/* Control Panel: Search & Filter Status */}
            ...
            <div className="border-t border-neutral-100 pt-4 space-y-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    onClick={() =>
                      handleUpdateStatus(selectedOrder.order_invoice, "PENDING")
                    }
              ...
              >
                <span className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider block">
                  <Truck size={14} className="inline mr-1 mb-0.5" /> Input Resi
                  Pengiriman Resmi
                </span>
