  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative overflow-hidden min-h-[650px] lg:min-h-[550px]">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
            ...
            >
              {`Add To Cart — Rp. ${formatRupiah(activeHero.price * quantity)
                .replace("Rp", "")
                .trim()}`}
            </button>
          </div>
          ...
          <div className="relative rounded-2xl bg-[#1C1C1C] text-[#EAE5D8] p-6 shadow-xl border border-neutral-800 space-y-6 flex-1 flex flex-col justify-between mt-4">
            <div className="space-y-3">
              ...
              <p className="text-xs text-neutral-400 leading-relaxed font-sans">
                This collection includes all essential items. Tactical bags
                feature adjustable webbing straps with metal tension sliders to
                calibrate absolute comfort.
              </p>
            </div>
      ...
      <section id="shop" className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="relative z-10 space-y-1">
            ...
            <p className="text-[10px] text-neutral-300 leading-normal max-w-xs font-sans">
              Koleksi terbaru gear outdoor untuk petualangan dan perjalanan
              aktif, selalu hadir dengan performa fungsional.
            </p>
        ...
        >
          ...
          <div className="relative z-10 space-y-1">
            ...
            <p className="text-[10px] text-neutral-300 leading-normal max-w-xs font-sans">
              Persiapan pendakian yang solid: sistem strap andal, bahan tahan
              cuaca, dan solusi penyimpanan yang rapi.
            </p>
        ...
        >
          <div className="space-y-3">
            ...
            <p className="text-xs text-neutral-500 leading-relaxed font-sans">
              ...
              Perlengkapan kami mendukung aktifitas lapangan tanpa mengurangi
              tampilan yang clean dan percaya diri.
            </p>
          </div>
      ...
      <section id="shoes" className="space-y-8 pt-6">
        <div className="border-b border-neutral-100 pb-5" data-aos="fade-right">
          ...
          <p className="text-xs text-neutral-500 mt-1 max-w-xl font-sans">
            Pilihan perlengkapan outdoor praktis dan tahan lama untuk hiking,
            traveling, serta aktifitas lapangan Anda.
          </p>
          ...
          <div className="md:col-span-3 space-y-2 sticky top-[100px]">
            ...
            >
              ...
              <p className="text-[11px] text-neutral-500 leading-normal font-sans">
                Pengiriman cepat dari Bandung untuk pemesanan tertentu; cek
                ketentuan gratis ongkir di halaman checkout.
              </p>
            </div>
          </div>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-16 bg-neutral-50 rounded-2xl border border-dashed border-neutral-200">
                ...
                <p className="text-neutral-400 font-sans text-xs mt-1 max-w-xs mx-auto">
                  Tidak ada produk yang cocok dengan "{searchQuery}" di kategori
                  ini. Coba periksa kembali ejaan Anda atau reset filter.
                </p>
                <button
                  onClick={() => {
      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-neutral-500 leading-relaxed font-sans">
              Produk Reptil Adventure dibuat dari bahan berkualitas tinggi yang
              tahan cuaca dan gesekan. Konstruksi jahitan ganda serta material
              fungsional menjaga kestabilan saat bergerak di berbagai kondisi.
            </p>
          </div>
          ...
          <div className="pt-6 space-y-3 border-t border-neutral-100">
            ...
            <div className="flex items-center gap-2.5 text-xs font-semibold text-neutral-800">
              ...
              <span>Material premium untuk penggunaan jangka panjang</span>
            </div>
          </div>
        </div>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 items-end justify-between">
            <div className="space-y-2">
              ...
              <p className="text-xs text-neutral-300 font-sans max-w-sm">
                Koleksi edisi terbatas untuk petualang yang mencari gear unik
                dan fungsional. Stok tetap terbatas, jadi segera cek detailnya.
              </p>
            </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-xs text-neutral-300 font-sans max-w-md">
                Dapatkan update produk outdoor terbaru, promo ongkir Bandung,
                dan tips pendakian langsung dari tim Reptil Adventure.
              </p>
            </div>
